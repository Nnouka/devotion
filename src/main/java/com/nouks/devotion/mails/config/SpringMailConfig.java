package com.nouks.devotion.mails.config;
...
public class SpringMailConfig implements ApplicationContextAware, EnvironmentAware {
    ...
    private static final String NO_REPLY_USERNAME = "mail.server.no-reply-username";
    private static final String NO_REPLY_PASSWORD = "mail.server.no-reply-password";
  ...
  private ApplicationContext applicationContext;
     ...
     */
    @Bean(name = "info-mail")
    public JavaMailSender infoMailSender() throws IOException {
  ...
  @Bean(name = "no-reply-mail")
  public JavaMailSender noReplyMailSender() throws IOException {
    ...
    mailSender.setPort(Integer.parseInt(this.environment.getProperty(PORT)));
    mailSender.setProtocol(this.environment.getProperty(PROTOCOL));
    mailSender.setUsername(this.environment.getProperty(NO_REPLY_USERNAME));
    mailSender.setPassword(this.environment.getProperty(NO_REPLY_PASSWORD));
